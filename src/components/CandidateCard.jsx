...
export default function CandidateCard({ candidate }) {
  ...
  return (
    <>
      <div className="relative h-[480px] w-[280px] sm:w-[320px] rounded-[2.5rem] overflow-hidden group shadow-2xl shadow-slate-900/10 candidate-card shrink-0">
        ...
        {/* <div className="absolute   top-6 right-6 z-10">
          <div className="px-4 py-1.5  bg-white/10 backdrop-blur-md border border-white/20 text-white text-[10px] font-black rounded-full uppercase tracking-[0.2em] shadow-xl">
            <p className="text-lg font-bold rotate-0 [writing-mode:horizontal-tb] whitespace-nowrap">
              {candidate.position}
            </p>
          </div>
        </div> */}
          ...
          <p className="text-xs text-shadow-lg font-black text-white/80 tracking-[0.25em] mb-8">
            <span className="line-clamp-3 wrap-break-word text-ellipsis">
              {candidate.platform?.[0]?.length > 20
                ...
                : candidate.platform?.[0] || "Leadership through action."}
            </span>
          </p>
        ...
        {/* Votes Count Overlay */}
        <div className="absolute bottom-8 right-8 pointer-events-none opacity-100 group-hover:opacity-100 transition-opacity duration-500">
